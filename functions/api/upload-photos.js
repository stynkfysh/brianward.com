...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
  <h2 style="color: #8b4513; border-bottom: 2px solid #8b4513; padding-bottom: 10px;">Property Photos Submitted</h2>
  <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
    ...
    <tr><td style="padding: 8px 12px; font-weight: 600;">Drive Folder</td><td style="padding: 8px 12px;"><a href="${escapeHtml(folderUrl)}" style="color: #8b4513;">Open in Google Drive</a></td></tr>
  </table>
  ...
  <p style="margin-top: 30px; padding-top: 16px; border-top: 1px solid #ddd; font-size: 13px; color: #888;">
    Submitted from brianward.com &mdash; photo upload form
  </p>
</body>
</html>`;
